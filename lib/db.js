...
async function initializeSchema() {
  ...
  try {
    ...
    const requiredTables = ['accounts', 'feature_events', 'comments', 'reactions', 'questions', 'answers', 'verse_suggestions', 'favorites', 'reflections', 'push_subscriptions', 'announcements', 'user_history']
