    ...
    <header className="church-header">
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-3 p-3 sm:p-4">
        <Link href="/" className="flex items-center gap-3">
          <img src="/logo.png" alt="Coptic Daily Readings" className="h-[4.5rem] w-auto" />
          <span className="font-bold text-lg text-white tracking-wide">Coptic Daily Readings</span>
        </Link>
        <nav className="flex flex-wrap items-center justify-end gap-3 sm:gap-6 w-auto text-sm text-white/90">
